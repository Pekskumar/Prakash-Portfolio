...
const ProjectCard = (props) => {
    ...
    return (
        <div className='project-card round-border p-4 mb-4'>
            ...
            <p className='project-detail text-gray'>{`${props.data.detail.substring(0, 120)}...`}<span className='cursor-pointer' onClick={() => setProjectModal(true)}><b>read more</b></span></p>

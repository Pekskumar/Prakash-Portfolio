            ...
            <Col md={6}>
                <div className='section-header   text-center'>
                    <div className='position-relative'>
                        <h2 className='m-0 mb-4'>About Me</h2>
                        {/* <ArrowIcon /> */}
                    </div>

                </div>
                <div className='project-btn body-text mb-3'>
                    <div className='mb-3'>Hey, I'm <b>Prakash Parmar</b>, a <b>frontend engineer</b> who builds things using technologies I've learned so far, such as <b>React js, JavaScript, HTML, CSS, React Bootstrap.</b> I'm always looking forward to learning new things as I grow, and I love keeping myself updated with the <b>rapidly</b> changing <b>tech world.</b></div>
                    <div className='mb-3'>My portfolio boasts a diverse range of <b>web applications </b>, spanning from innovative <b>e-commerce</b> platforms to engaging <b>social networking</b> sites. I pride myself on creating <b>scalable and efficient solutions</b> that adhere to <b>industry best practices</b>, ensuring <b>optimal performance and user satisfaction.</b></div>
                    <div className='mb-3'>I strongly believe in <b>continuous learning and improving myself,</b> so I try my best to learn in <b>any situation possible, unfavorable or not.</b></div>
